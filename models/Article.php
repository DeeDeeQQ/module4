...
class Article
{
    ...
    public static function getArticleListByCategory($categoryId = false, $page = 1)
    {
        if($categoryId) {
            ...
            $result = $db->query("SELECT id, title FROM article "
    ...
    public static function getArticlesList()
    {
        ...
        $result = $db->query('SELECT id, title, is_new, description FROM article ORDER BY id ASC');
        $articlesList = [];
        $i = 0;
    ...
    public static function createArticle($options)
    {
        ...
        $sql = 'INSERT INTO article '
            . '(title, category_id, analytic,'
            . 'description, is_new)'
            . 'VALUES (:title, :category_id, :analytic, :description, :is_new)';
   ...
   public static function getImage($id)
    ...
    public static function getLastArticles()
    {
        ...
        $result = $db->query('SELECT id, title, is_new, description FROM article ORDER BY id DESC LIMIT 3');
        $articlesList = [];
        $i = 0;
    ...
    public static function getArticlesByIds($articlesIdsList)
    {
        ...
        $sql = "SELECT id, title FROM article WHERE id IN ($idString)";
