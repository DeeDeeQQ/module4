    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <h2>Категория <a href="/category/<?=$categoryTitle['id']?>"><?=$categoryTitle['title']?></a></h2>
                ...
                <h5>Смотрят сейчас <?php Article::currentVisitors() ?></h5>
                ...
                <div class="col-sm-5">
                    ...
                    <?php } ?>
                        ...
                        <?php if($comment['category_id'] == 5 && $comment['validation'] == 0 ){ ?>
                            <p><a href="/user/<?=$comment['user_id']?>">Автор <?=Comment::getUserById($comment['user_id'])?></a> </p>
                            <p><?=$comment['description']?></p>
                            <p><?=$comment['date']?></p>
